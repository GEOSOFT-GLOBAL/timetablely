const zh = {
  ...
  courses: {
    ...
    addDesc: "创建新的{{course}}。",
    noneMatchFilter: "没有{{courses}}符合此筛选",
    unassigned: "未指派",
    perWeek: "每周 {{count}} 个课时",
    noBackToBack: "不连排",
  },
  ...
  workspace: {
    ...
    none: "你还没有加入任何工作空间。创建一个，或使用邀请码加入团队。",
    name: "工作空间名称",
    create: "创建工作空间",
    createDesc: "先创建工作空间，设置好后再邀请团队。",
    join: "加入工作空间",
    joinDesc: "输入管理员分享给你的邀请码。",
    created: "{{name}} 已就绪",
    joined: "你已加入 {{name}}",
    code: "邀请码",
    copyCode: "复制邀请码",
    codeCopied: "邀请码已复制!",
    copyFailed: "无法复制——请手动选中并复制邀请码。",
    createInvite: "创建邀请",
    inviteDesc: "发送邀请码或分享链接，两种方式都能加入此工作空间。",
    openInvite: "公开邀请（任何拿到链接的人）",
    noInvites: "没有待处理的邀请。",
    adminOnly: "只有管理员可以邀请他人。",
    members: "成员",
    membersDesc: "所有可以访问此工作空间的人。",
    memberCount: "此工作空间有 {{count}} 位{{members}}",
    switch: "切换",
    you: "（你）",
  },
