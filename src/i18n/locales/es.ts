const es = {
  ...
  courses: {
    ...
    addDesc: "Crea un nuevo {{course}}.",
    noneMatchFilter: "Ningún {{courses}} coincide con este filtro",
    unassigned: "Sin asignar",
    perWeek_one: "{{count}} periodo/semana",
    perWeek: "{{count}} periodos/semana",
    noBackToBack: "Sin consecutivos",
  },
  ...
  workspace: {
    ...
    none: "Aún no perteneces a ningún espacio de trabajo. Crea uno o únete a tu equipo con un código de invitación.",
    name: "Nombre del espacio de trabajo",
    create: "Crear espacio de trabajo",
    createDesc: "Crea un espacio de trabajo e invita a tu equipo cuando estés listo.",
    join: "Unirse a un espacio",
    joinDesc: "Introduce el código que te compartió un administrador.",
    created: "{{name}} está listo",
    ...
    inviteDesc: "Envía un código o comparte el enlace. Cualquiera de los dos da acceso a este espacio.",
    openInvite: "Invitación abierta (cualquiera con el enlace)",
    noInvites: "No hay invitaciones pendientes.",
    adminOnly: "Solo los administradores pueden invitar a otras personas.",
    members: "Miembros",
    membersDesc: "Todas las personas con acceso a este espacio de trabajo.",
    memberCount: "{{count}} {{members}} en este espacio de trabajo",
    switch: "Cambiar",
    you: "(tú)",
  },
